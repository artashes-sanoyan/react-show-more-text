...
class Truncate extends _react.default.Component {
  constructor() {
    ...
    _defineProperty(this, "calcTargetWidth", (callback) => {
      ...
      //   ? Number(style["letter-spacing"].replace("px", ""))
      //   : 0;
    ...
    _defineProperty(this, "measureWidth", (text) => {
      const letterSpacing = Number(
        this.canvasContext.letterSpacing.replace("px", "")
      );
      return this.canvasContext.measureText(text).width + letterSpacing;
    });
    ...
    _defineProperty(this, "getLines", () => {
      ...
      for (let line = 1; line <= numLines; line++) {
        ...
        if (line === numLines) {
          ...
          resultLine = /*#__PURE__*/ _react.default.createElement(
            "span",
            null,
            lastLineText,
            ellipsis
